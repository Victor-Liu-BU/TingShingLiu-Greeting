package com.example.tingshingliu_greeting
...
import com.example.tingshingliu_greeting.ui.theme.TingShingLiuGreetingTheme
...
fun Greeting() {
    ...
    Column(
        ...
        Button(
            onClick = {
                greeting = getGreetingMessage(name)
            },
